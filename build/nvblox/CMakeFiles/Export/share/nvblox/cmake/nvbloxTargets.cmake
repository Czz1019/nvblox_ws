...
foreach(_expectedTarget nvblox::nvblox_lib nvblox::nvblox_datasets nvblox::nvblox_eigen nvblox::fuse_3dmatch nvblox::fuse_replica)
...
set_target_properties(nvblox::nvblox_lib PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "/usr/local/cuda/include;${_IMPORT_PREFIX}/include;${_IMPORT_PREFIX}/include/nvblox"
  INTERFACE_LINK_LIBRARIES "glog::glog;gflags_nothreads_static;nvblox::nvblox_eigen;CUDA::cudart"
)
...
foreach(_target "glog::glog" "gflags_nothreads_static" )
